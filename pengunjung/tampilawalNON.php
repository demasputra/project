...
<head>
    ...
    <link rel="icon" href="img/oracle.png">
...
<form action="" method="post">
	<table class="table" >
		...
		<tr>
			...
			<td></td>
			<td>
				<input  class="form-control" type="text" name="Alamat" placeholder="Kelas Pengunjung" size="30">
			</td>
		</tr>
		<tr>
			<td>Jurusan</td>
			<td></td>
			<td>
				<input  class="form-control" type="text" name="Instansi" placeholder="Asal Jurusan" size="30">
			</td>
		</tr>
		<tr>
			<td>Tujuan</td>
			...
			<td>
				<select  class="form-control" name="Tujuan"> 
					...
					<option>Coba Coba</option>
					<option>Pengen Foto</option>
					<option>Jajan</option>
...
<?php 
 if (isset($_POST['tambah'])){
 	...
 	if ($nama == '' || $Alamat =='' || $Tujuan ==''){
 		...
 		alert('SELAMAT DATANG DI KELAS XI ORACLE SMKN 4 PADALARANG');
 		document.location.href = 'tampilawalNON.php';
 		</script>
 		";
 		}else {
